...
class UnidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unidade" do
    assert_difference('Unidade.count') do
      post unidades_url, params: { unidade: { endereco: @unidade.endereco, nome: @unidade.nome, telefone: @unidade.telefone } }
    end
  ...
  test "should update unidade" do
    patch unidade_url(@unidade), params: { unidade: { endereco: @unidade.endereco, nome: @unidade.nome, telefone: @unidade.telefone } }
