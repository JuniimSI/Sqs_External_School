...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { data_nascimento: @aluno.data_nascimento, nome: @aluno.nome, turma_id: @aluno.turma_id } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { data_nascimento: @aluno.data_nascimento, nome: @aluno.nome, turma_id: @aluno.turma_id } }
