...
class ResponsavelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsavel" do
    assert_difference('Responsavel.count') do
      post responsavels_url, params: { responsavel: { aluno_id: @responsavel.aluno_id, email: @responsavel.email, nome: @responsavel.nome, telefone: @responsavel.telefone } }
    end
  ...
  test "should update responsavel" do
    patch responsavel_url(@responsavel), params: { responsavel: { aluno_id: @responsavel.aluno_id, email: @responsavel.email, nome: @responsavel.nome, telefone: @responsavel.telefone } }
